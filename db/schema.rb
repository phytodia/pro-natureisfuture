...
ActiveRecord::Schema[7.0].define(version: 2024_07_25_113118) do
  ...
  create_table "slides", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["slider_home_id"], name: "index_slides_on_slider_home_id"
  end
  ...
  add_foreign_key "slides", "slider_homes"
